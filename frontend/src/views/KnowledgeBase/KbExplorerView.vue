...
<template>
  <div class="max-w-7xl mx-auto py-8">
    <div class="text-center mb-12">
      <h1 class="text-4xl font-extrabold text-content tracking-tight mb-4">
      ...
      <div class="max-w-2xl mx-auto flex gap-2">
        ...
        >
        <button
          class="bg-primary text-white px-6 py-3 rounded-md hover:bg-primary-dark transition font-medium"
          @click="search"
        >
          Buscar
        </button>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div class="col-span-1 md:col-span-3">
        ...
        <div
          ...
          class="text-center py-12 bg-surface rounded-lg shadow-sm"
        >
          <svg
          ...
          >
            ...
            <div class="mt-4 flex items-center text-sm text-muted space-x-4">
              <span
                ...
                class="bg-surface/50 px-2 py-1 rounded"
