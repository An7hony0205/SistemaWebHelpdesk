...
<template>
  <div class="max-w-4xl mx-auto py-8">
    <button
      class="mb-6 text-primary hover:text-primary-dark font-medium flex items-center"
      @click="goBack"
    >
      <svg
        class="w-5 h-5 mr-1"
    ...
    >
      ...
      <div class="p-8 border-b border-subtle bg-background">
        <div class="flex items-center space-x-2 text-sm text-muted mb-4">
          <span
            ...
            class="uppercase font-semibold tracking-wider text-primary"
      ...
      <div class="px-8 py-6 bg-background border-t border-subtle flex justify-between items-center">
        ...
        <div class="flex items-center space-x-2">
          ...
          <button class="p-2 rounded hover:bg-gray-200 text-muted">
            👍
          </button>
          <button class="p-2 rounded hover:bg-gray-200 text-muted">
            👎
