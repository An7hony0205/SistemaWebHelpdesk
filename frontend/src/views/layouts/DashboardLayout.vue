  ...
  <div class="min-h-screen bg-background flex font-body">
    ...
    <div class="w-64 bg-surface shadow-xl border-r border-subtle">
      ...
      <nav class="p-4 space-y-2 font-brand">
        <router-link
          :to="{ name: 'Dashboard' }"
          class="block px-4 py-2 text-muted rounded-md hover:bg-black/10 dark:hover:bg-white/10 hover:text-primary transition-colors"
        >
          Dashboard
        </router-link>
        <router-link
          :to="{ name: 'Tickets' }"
          class="flex items-center px-4 py-2 text-muted hover:bg-black/10 dark:hover:bg-white/10 rounded-md"
        >
          <svg
        ...
        <router-link
          ...
          :to="{ name: 'Automations' }"
          class="block px-4 py-2 text-muted rounded-md hover:bg-black/10 dark:hover:bg-white/10 hover:text-primary transition-colors flex items-center"
        >
          <svg
            class="w-5 h-5 mr-3 text-muted"
            fill="none"
